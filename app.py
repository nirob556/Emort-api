...
async def perform_emote(team_code: str, uids: list, emote_id: int):
    ...
    try:
        ...
        # Automatically leave the group after emotes
        await asyncio.sleep(1)  # Wait 1 second after last emote
        leave_packet = await ExiT(None, key, iv)
        await SEndPacKeT(None, online_writer, 'OnLine', leave_packet)
        
        return {"status": "success", "message": "Emote performed successfully and left the group!"}
    except Exception as e:
...
def join_team():
    ...
    return jsonify({
        ...
        "message": "Emote performed successfully! Bot will leave the group automatically."
    })
...
async def MaiiiinE():
    ...
    Uid , Pw = '4367154098','6799B0805859BB7325E43148870677BC140268C20443335515737BF8288FF966'
