...
# === ফিক্সড অংশ: runtime_version safely handle করা হয়েছে ===
try:
    ...
    # পুরানো protobuf (4.x বা তার নিচে) হলে এই চেকটা skip করবে
    # কোনো এরর দেবে না, শুধু চুপচাপ চলবে
    pass
# ==================================================================
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    b'\n\x16DecodeWhisperMsg.proto\"\xa8\x02\n\rDecodeWhisper\x12$\n\x04Data\x18\x05 \x01(\x0b\x32\x16.DecodeWhisper.Nested1\x1a\xf0\x01\n\x07Nested1\x12\x0b\n\x03uid\x18\x01 \x01(\x04\x12\x0f\n\x07Chat_ID\x18\x02 \x01(\x04\x12\x11\n\tchat_type\x18\x03 \x01(\x05\x12\x0b\n\x03msg\x18\x04 \x01(\t\x12/\n\x07Details\x18\t \x01(\x0b\x32\x1e.DecodeWhisper.Nested1.Nested2\x12\x35\n\rPlatform_Info\x18\r \x01(\x0b\x32\x1e.DecodeWhisper.Nested1.Nested3\x1a\x1b\n\x07Nested2\x12\x10\n\x08Nickname\x18\x01 \x01(\t\x1a\"\n\x07Nested3\x12\x17\n\x0fprofile_pic_url\x18\x01 \x01(\tb\x06proto3'
)

_globals = globals()
_builder.BuildMessageAndEnumDescriptors(DESCRIPTOR, _globals)
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'DEcwHisPErMsG_pb2', _globals)
