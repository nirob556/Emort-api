...
# Fixed for full compatibility with protobuf 4.x, 5.x and 6.x
...
# ===== নিরাপদ runtime_version হ্যান্ডলার (অন্য ফাইলের সাথে মিল রাখার জন্য) =====
try:
    from google.protobuf import runtime_version as _runtime_version
    # যদি নতুন protobuf (5.x/6.x) থাকে তাহলে চেক করবে
    _runtime_version.ValidateProtobufRuntimeVersion(
        _runtime_version.Domain.PUBLIC,
        4, 25, 1, '', 'MajorLoginReq.proto'
    )
except (ImportError, AttributeError):
    # পুরানো protobuf (4.x) হলে চুপচাপ skip করবে — কোনো এরর দেবে না
    pass
# ==========================================================================
